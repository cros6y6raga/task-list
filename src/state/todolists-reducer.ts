...
export const todolistsReducer = (state: Array<TodolistsType>, action: MainTypeTodolists) => {
    switch (action.type) {
...
export type MainTypeTodolists = removeTodolistACType | addTodolistACType | editTodoACType | filterTasksACType
